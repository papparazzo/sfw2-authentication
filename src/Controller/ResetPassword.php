...
class ResetPassword
{
    ...
    public function __construct(
        ...
        private readonly DateTimeHelperInterface $dateTimeHelper,
        private readonly MailerInterface $mailer,
        private readonly RenderInterface $render,
        private readonly string $loginChangePath
    ) {
    }
    ...
    public function index(Request $request, Response $response): Response
    {
        ...
        try {
            $user = (new UserRepository($this->database))->loadUserByEmailAddress($user);
        } catch(Throwable) {
            return $this->returnError($request, $response);
        }
        ...
        return $this->render->render($request, $response, [
            ...
            'description' => "
                <p>
                    Die Bestätigungsnachricht wurde erfolgreich verschickt.
                </p>
                <p>
