...
CREATE TABLE IF NOT EXISTS `{TABLE_PREFIX}_authentication_user` (
...
ALTER TABLE `{TABLE_PREFIX}_authentication_user` ADD PRIMARY KEY (`Id`);
ALTER TABLE `{TABLE_PREFIX}_authentication_user` MODIFY `Id` INT(11) UNSIGNED NOT NULL AUTO_INCREMENT;
